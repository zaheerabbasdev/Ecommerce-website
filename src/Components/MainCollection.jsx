...
const MainCollection = () => {
  ...
  const cardData = [
  { image: image1, title: "Kid Tapered Slim Fit Trouser", price: "$76", category: "Kids", type: "Bottomwear"  },
  { image: image2, title: "Men Round Neck Pure Cotton T-shirt", price: "$85", category: "Men", type: "Topwear" },
  { image: image3, title: "Boy Round Neck Pure Cotton T-shirt", price: "$90", category: "Kids", type: "Topwear" },
  { image: image4, title: "Women Zip-Front Relaxed Fit Jacket", price: "$120", category: "Women", type: "Winterwear" },
  { image: image5, title: "Men Tapered Fit Flat-Front Trousers", price: "$150", category: "Men", type: "Bottomwear" },
  { image: image6, title: "Girls Round Neck Cotton Top", price: "$76", category: "Kids", type: "Topwear" },
  { image: image7, title: "Women Zip-Front Relaxed Fit Jacket", price: "$85", category: "Women", type: "Winterwear" },
  { image: image8, title: "Kid Tapered Slim Fit Trouser", price: "$90", category: "Kids", type: "Bottomwear" },
  { image: image9, title: "Men Printed Plain Cotton Shirt", price: "$120", category: "Men", type: "Topwear" },
  { image: image10, title: "Women Zip-Front Relaxed Fit Jacket", price: "$150", category: "Women", type: "Winterwear" },
  { image: image11, title: "Boy Casual Slim Fit Jeans", price: "$80", category: "Kids", type: "Bottomwear" },
  { image: image12, title: "Men Cotton Full-Sleeve Shirt", price: "$90", category: "Men", type: "Topwear" },
  { image: image13, title: "Boys Casual Striped T-Shirt", price: "$70", category: "Kids", type: "Topwear" },
  { image: image14, title: "Women Cropped Hooded Sweatshirt", price: "$130", category: "Women", type: "Winterwear" },
  { image: image15, title: "Men Slim Fit Denim Jeans", price: "$140", category: "Men", type: "Bottomwear" },
  { image: image16, title: "Girls Printed Fleece Hoodie", price: "$75", category: "Kids", type: "Winterwear" },
  { image: image17, title: "Women Long-Sleeve Fleece Hoodie", price: "$110", category: "Women", type: "Winterwear" },
  { image: image18, title: "Boy Tapered Fit Denim Pants", price: "$95", category: "Kids", type: "Bottomwear" },
  { image: image19, title: "Men Linen Casual Shirt", price: "$125", category: "Men", type: "Topwear" },
  { image: image20, title: "Women Puffer Jacket", price: "$180", category: "Women", type: "Winterwear" },
  { image: image21, title: "Kid Slim Fit Jogger Pants", price: "$85", category: "Kids", type: "Bottomwear" },
  { image: image22, title: "Men Half-Sleeve Printed T-Shirt", price: "$90", category: "Men", type: "Topwear" },
  { image: image23, title: "Boy Graphic Round Neck T-Shirt", price: "$60", category: "Kids", type: "Topwear" },
  { image: image24, title: "Women Fleece Zipper Hoodie", price: "$120", category: "Women", type: "Winterwear" },
  { image: image25, title: "Men Relaxed Fit Cotton Trousers", price: "$170", category: "Men", type: "Bottomwear" },
  { image: image26, title: "Girls Floral Printed Top", price: "$65", category: "Kids", type: "Topwear" },
  { image: image27, title: "Women Quilted Winter Coat", price: "$160", category: "Women", type: "Winterwear" },
  { image: image28, title: "Kid Casual Tapered Fit Pants", price: "$95", category: "Kids", type: "Bottomwear" },
  { image: image29, title: "Men Slim Fit Cotton Shirt", price: "$130", category: "Men", type: "Topwear" },
  { image: image30, title: "Women Hooded Bomber Jacket", price: "$190", category: "Women", type: "Winterwear" },
  { image: image32, title: "Men Graphic Printed T-Shirt", price: "$85", category: "Men", type: "Topwear" },
  // { image: image33, title: "Boy Polo Neck Casual T-Shirt", price: "$80", category: "Kids", type: "Topwear" },
  { image: image34, title: "Women Casual Hooded Sweatshirt", price: "$140", category: "Women", type: "Winterwear" },
  { image: image35, title: "Men Cotton Chinos", price: "$155", category: "Men", type: "Bottomwear" },
